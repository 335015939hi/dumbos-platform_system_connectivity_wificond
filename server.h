...
class WifiEventCallbackHandler
...
class WifiChipEventCallbackHandler
...
class Server : public android::net::wifi::BnWificond {
 ...
 private:
  ...
  sp<WifiEventCallbackHandler> hal_event_callback_handler_;
  sp<WifiChipEventCallbackHandler> hal_chip_event_callback_handler_;
