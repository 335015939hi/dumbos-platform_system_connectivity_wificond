...
class Server : public android::net::wifi::BnWificond,
 ...
 public:
  ...
  android::hardware::Return<void> onDebugRingBufferConnectivityEventEntriesAvailable(const android::hardware::wifi::V1_0::WifiDebugRingBufferStatus& status, const android::hardware::hidl_vec<android::hardware::wifi::V1_0::WifiDebugRingEntryConnectivityEvent>& entries) override;
  android::hardware::Return<void> onDebugRingBufferPowerEventEntriesAvailable(const android::hardware::wifi::V1_0::WifiDebugRingBufferStatus& status, const android::hardware::hidl_vec<android::hardware::wifi::V1_0::WifiDebugRingEntryPowerEvent>& entries) override;
  android::hardware::Return<void> onDebugRingBufferWakelockEventEntriesAvailable(const android::hardware::wifi::V1_0::WifiDebugRingBufferStatus& status, const android::hardware::hidl_vec<android::hardware::wifi::V1_0::WifiDebugRingEntryWakelockEvent>& entries) override;
  android::hardware::Return<void> onDebugRingBufferVendorDataEntriesAvailable(const android::hardware::wifi::V1_0::WifiDebugRingBufferStatus& status, const android::hardware::hidl_vec<android::hardware::wifi::V1_0::WifiDebugRingEntryVendorData>& entries) override;
