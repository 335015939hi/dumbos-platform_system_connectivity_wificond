...
class ClientInterfaceImpl : public android::hardware::wifi::supplicant::V1_0::ISupplicantIfaceCallback {
 public:
  ClientInterfaceImpl(
 ...
 private:
  ...
  android::hardware::Return<void> onStateChanged(android::hardware::wifi::supplicant::V1_0::ISupplicantIfaceCallback::State newState, const android::hardware::hidl_array<uint8_t, 6 /* 6 */>& bssid, uint32_t id, const android::hardware::hidl_vec<uint8_t>& ssid) override;
  ...
  android::sp<android::hardware::wifi::supplicant::V1_0::ISupplicant> supplicant_hidl_;
  android::sp<android::hardware::wifi::supplicant::V1_0::ISupplicantIface>
