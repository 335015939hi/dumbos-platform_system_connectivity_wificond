...
class NetlinkUtils {
 public:
  ...
  virtual bool GetWiphyCapabilities(uint32_t wiphy_index,
                                    BandInfo* out_band_info,
                                    ScanCapabilities* out_scan_capabilities);
 private:
  bool GetBandInfo(const NL80211Packet* const packet,
                   BandInfo* out_band_info);
  bool GetScanCapabilities(const NL80211Packet* const packet,
                           ScanCapabilities* out_scan_capabilities);
