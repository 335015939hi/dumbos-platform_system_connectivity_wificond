...
class MlmeEventHandler {
 public:
  ...
  virtual void OnConnect(const MlmeConnectEvent* event) = 0;
  virtual void OnRoam(const MlmeRoamEvent* event) = 0;
  virtual void OnAssociate(const MlmeAssociateEvent* event) = 0;
