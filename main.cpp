...
int SetupHwBinderOrCrash() {
  ...
  int err = android::hardware::IPCThreadState::self()->setupPolling(&hwbinder_fd);
...
int main(int argc, char** argv) {
  ...
  CHECK(event_dispatcher->WatchFileDescriptor(
      hwbinder_fd,
      android::wificond::EventLoop::kModeInput,
      &OnHwBinderReadReady)) << "Failed to watch hwbinder FD";
  ...
  CHECK(hal) << "Failed to connect to HAL";
