...
class MockOffload : public IOffload {
  ...
  MOCK_METHOD2(configureScans, ::android::hardware::Return<void>(const ScanParam &param, const ScanFilter &Filter));
  MOCK_METHOD1(getScanStats, ::android::hardware::Return<void>(OnScanStatsCallback cb));
  MOCK_METHOD1(subscribeScanResults, ::android::hardware::Return<void>(uint32_t delayMs));
  MOCK_METHOD0(unsubscribeScanResults, ::android::hardware::Return<void>());
  MOCK_METHOD1(setEventCallback, ::android::hardware::Return<void>(const android::sp<IOffloadCallback>& cb));
