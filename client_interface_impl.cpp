...
bool ClientInterfaceImpl::GetPacketCounters(unique_ptr<vector<int64_t>>* out_packet_counters) {
  return netlink_utils_->GetPacketCounters(interface_index_,
                                           interface_mac_addr_,
                                           out_packet_counters->get());
}
