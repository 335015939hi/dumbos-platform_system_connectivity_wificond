...
android::sp<IOffload> OffloadScanUtils::getOffloadService() {
  return IOffload::getService();	
}

android::sp<OffloadCallback> OffloadScanUtils::getOffloadCallback(OnOffloadScanResultsReadyHandler handler) {
  return new OffloadCallback(handler);
}

std::vector<::com::android::server::wifi::wificond::NativeScanResult> OffloadScanUtils::convertToNativeScanResults(const std::vector<ScanResult> scanResult) {
  std::vector<::com::android::server::wifi::wificond::NativeScanResult> nativeScanResult;
