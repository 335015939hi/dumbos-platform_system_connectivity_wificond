...
class OffloadScanResultHandler {
public:
  OffloadScanResultHandler(OnOffloadScanResultsReadyHandler);
  ~OffloadScanResultHandler();
...
private:
  std::unique_ptr<OffloadScanResultHandler> scan_result_handler_;
};
