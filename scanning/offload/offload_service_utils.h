...
class OffloadServiceUtils {
 public:
  OffloadServiceUtils();
  virtual ~OffloadServiceUtils();
  android::sp<IOffload> getOffloadService();
  android::sp<OffloadCallback> getOffloadCallback(OnOffloadScanResultsReadyHandler handler);
};
